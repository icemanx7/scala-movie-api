...
final case class MovieReview(userEmail: String, review: String, movieID: String)

final case class Review(id: Option[String], review: String, reviewRating: Double, reviewDate: String)

final case class ReviewComp(movieReviewID: String, movieID: String, reviewID: String, userID: String)
